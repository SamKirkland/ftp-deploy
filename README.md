...
| `--log-unchanged-files`   | No       | `false`                    | `true`                                        | Prints also unchanged files to the console, not only ones that will actually be added/updated/changed (requires at least `standard` log level)                     |
