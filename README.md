...
| `--exclude`               | No       | `nuclearLaunchCodes.txt`   | `.git*` `**/.git*` `.git*/**` `**/.git*/**` `node_modules/**` `node_modules/**/*` | An array of glob patterns, these files will not be included in the publish/delete process                                                                          |
